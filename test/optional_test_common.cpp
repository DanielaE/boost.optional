...
inline void check_is_pending_copy      ( X const* ) { BOOST_CHECK( X::pending_copy ) ; }
inline void check_is_pending_dtor      ( X const* ) { BOOST_CHECK( X::pending_dtor ) ; }
inline void check_is_pending_assign    ( X const* ) { BOOST_CHECK( X::pending_assign ) ; }
inline void check_is_not_pending_copy  ( X const* ) { BOOST_CHECK( !X::pending_copy ) ; }
inline void check_is_not_pending_dtor  ( X const* ) { BOOST_CHECK( !X::pending_dtor ) ; }
inline void check_is_not_pending_assign( X const* ) { BOOST_CHECK( !X::pending_assign ) ; }
inline void check_instance_count       ( int c, X const* ) { BOOST_CHECK( X::count == c ) ; }
